...
>
  <!-- Background image -->
  <div
    class="pointer-events-none absolute inset-0 opacity-40 md:inset-y-0 ml-auto md:right-0 md:w-2/3 md:opacity-100"
    aria-hidden="true"
  >
    <div
    ...
    >
      ...
      <div class="hidden md:block h-full w-full bg-linear-to-l from-on-primary/0 via-on-primary/25 to-on-primary"></div>
    </div>
  </div>

  <!-- Content -->
  <div
    class="relative z-10 py-16 mt-auto mr-auto flex max-w-6xl flex-col gap-12 px-6 lg:flex-row lg:items-center lg:gap-20"
  >
    <div class="flex-1 text-center lg:text-left">
      ...
      >
        <span
          class="inline-block text-secondary scale-x-[-1]"
        >
          Designer
        </span>
        <span
          class="inline-block text-text"
        >
          Developer
        </span>
      ...
      <p class="mt-6 max-w-xl text-base leading-relaxed text-muted lg:text-lg">
